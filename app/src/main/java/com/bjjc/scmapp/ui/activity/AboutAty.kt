...
import com.bjjc.scmapp.presenter.manager.QRCodeScanner
import com.bjjc.scmapp.presenter.manager.ScannerManager
...
class AboutAty : BaseActivity() {
    //========================================Field==================================================================================
    companion object {
        private val TAG: String = AboutAty::class.java.simpleName
    }
    ...
    override fun initData() {
        ...
        tv_latitude.text = GpsUtils.getGPSPointString(this)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (resultCode) {
            RESULT_OK ->
            {
                ...
                FeedbackUtils.vibrate(this, 200)
                //onScanCodeFailure()
                Log.d("AboutAty",data?.extras?.getString("result"))
